...
<div class="btn-group btn-group-lg">
  <button
    on:click={() => upgrade("upgrade")}
    class="btn btn-primary px-4 py-2"
    type="button"
    disabled={$_clicker.upcost >= $_clicker.money}
    >Unit Upgrade</button
  >

  <button
    on:click={() => upgrade("clicker cat")}
    class="btn btn-primary px-4 py-2"
    type="button"
    disabled={$_clicker.catcost >= $_clicker.money}
    >Cats Upgrade</button
  >
  ...
  <button
    ...
    class="btn btn-primary px-4 py-2"
    type="button"
    disabled={$_clicker.workercost >= $_clicker.money}
